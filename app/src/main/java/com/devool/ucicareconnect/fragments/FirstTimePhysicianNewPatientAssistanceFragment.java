...
public class FirstTimePhysicianNewPatientAssistanceFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View row = inflater.inflate(R.layout.fragment_first_time_physician_new_patient_assistance, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_yes:
                strAssistance = btnyes.getText().toString();
                ...
                FirstTimePhysicianPatientPreviousFacilityFragment fragment = new FirstTimePhysicianPatientPreviousFacilityFragment();
                ...
                break;
            case R.id.btn_no:
                strAssistance = btnNo.getText().toString();
                ...
                FirstTimePhysicianNewPtRequest fragment1 = new FirstTimePhysicianNewPtRequest();
                ...
                args1.putString("strAssistance", strAssistance);
