...
public class ReferralAssociateName extends Fragment implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        strReferalName = getArguments().getString("Referral_name");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View row = inflater.inflate(R.layout.fragment_referral_associate_name, container, false);
    ...
    private void submitAssociateName() {
