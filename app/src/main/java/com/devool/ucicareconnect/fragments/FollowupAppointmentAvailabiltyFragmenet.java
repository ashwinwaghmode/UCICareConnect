...
public class FollowupAppointmentAvailabiltyFragmenet extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View row = inflater.inflate(R.layout.fragment_followup_appointment_availabilty_fragmenet, container, false);
        btnThisWeek = row.findViewById(R.id.btn_this_week);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_this_week:
                strFollowupAvailability = btnThisWeek.getText().toString();
            ...
            case R.id.btn_next_week:
                strFollowupAvailability = btnNextWeek.getText().toString();
            ...
            case R.id.btn_as_soon_as_possible:
                strFollowupAvailability = btnSoonPossible.getText().toString();
                btnSoonPossible.setBackground(getResources().getDrawable(R.drawable.fill_appointment_button_corner));
                btnSoonPossible.setTextColor(getResources().getColor(R.color.btn_text_color));
                submit();
                break;
                    ...
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            if (object.getString("inMsg").equalsIgnoreCase("Request Saved!!!")) {
                                ...
                                FollowupAppointmentTimeofDayFragmrnt fragment = new FollowupAppointmentTimeofDayFragmrnt();
