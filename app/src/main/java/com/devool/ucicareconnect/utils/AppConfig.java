...
public class AppConfig {
    public static final String BASE_URL = "http://54.153.126.152:6002/api/Master/";
    ...
    public static final String GET_USER_FROM_EMAIl = "GetUserfromEmail";
    public static final String UPDATE_LOGIN_USER = "UpdateLoginUser";
